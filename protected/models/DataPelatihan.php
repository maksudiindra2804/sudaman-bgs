...
/**
 * This is the model class for table "data_pelatihan".
 *
 * The followings are the available columns in table 'data_pelatihan':
 ...
 * @property ChildPelatihan[] $childPelatihans
...
class DataPelatihan extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('jenis, status', 'length', 'max'=>100),
			array('tgl_data', 'safe'),
			/*
			//Example username
			...
			array('id_pelatihan, jenis, tgl_data, status', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'childPelatihans' => array(self::HAS_MANY, 'ChildPelatihan', 'id_pelatihan'),
			'dataTalents' => array(self::HAS_MANY, 'DataTalent', 'id_pelatihan'),
		);
	}
