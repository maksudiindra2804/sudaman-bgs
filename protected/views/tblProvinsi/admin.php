<?php
/* @var $this TblProvinsiController */
/* @var $model TblProvinsi */

$this->breadcrumbs=array(
	'Tbl Provinsis'=>array('index'),
	'Manage',
);
...
$this->menu=array(
	array('label'=>'TblProvinsi','url'=>array('index'),'icon'=>'fa fa-list-alt', 'items' => $menu)	
);
...
$('.search-form form').submit(function(){
	$('#tbl-provinsi-grid').yiiGridView('update', {
		data: $(this).serialize()
	});
	return false;
});
	    ...
	    */
	    array(
            ...
            (
                'view' => array
                (    
                	'url' => '$data->provinsi_id."|".$data->provinsi_id',              
                	'click' => 'function(){
