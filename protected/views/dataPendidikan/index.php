<?php
/* @var $this DataPendidikanController */
...
$this->menu=array(
	array('label'=>'DataPendidikan','url'=>array('index'),'icon'=>'fa fa-list-alt', 'items' => $menu)	
);
...
Yii::app()->clientScript->registerScript('search', "
	...
	$('.search-form form').submit(function(){
		$.fn.yiiGridView.update('data-pendidikan-grid', {
			data: $(this).serialize()
		});
		return false;
	});
...
Yii::app()->clientScript->registerScript('refreshGridView', "
	...
	//setInterval(\"$.fn.yiiGridView.update('data-pendidikan-grid')\",5000);
");
