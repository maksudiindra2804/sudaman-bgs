...
$menu[]=array('label'=>'Tambah Data Trainner','url'=>array('create'),'icon'=>'fa fa-plus-circle','active'=>($currAction=='create')?true:false);

if(in_array($currAction,array('index','view','create','update','admin','calendar','import')))
$menu[]=array('label'=>'Data Trainner','url'=>array('admin'),'icon'=>'fa fa-list','active'=>($currAction=='admin')?true:false);
