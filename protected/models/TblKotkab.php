...
/**
 * This is the model class for table "tbl_kotkab".
 *
 * The followings are the available columns in table 'tbl_kotkab':
 * @property integer $id_kotkab
 * @property string $provinsi_id
 * @property string $nama_kotkab
 ...
 */
class TblKotkab extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('nama_kotkab', 'length', 'max'=>255),
			...
			array('id_kotkab, provinsi_id, nama_kotkab, create_at', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'personals' => array(self::HAS_MANY, 'Personal', 'id_kotkab'),
	...
	public function search()
	{
		...
		$criteria->compare('nama_kotkab',$this->nama_kotkab,true);
	 ...
	 * @return TblKotkab the static model class
	 */
