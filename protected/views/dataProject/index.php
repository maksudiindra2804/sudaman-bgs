...
Yii::app()->clientScript->registerScript('search', "
	...
	$('.search-form form').submit(function(){
		$.fn.yiiGridView.update('data-project-grid', {
			data: $(this).serialize()
		});
		return false;
	});
...
Yii::app()->clientScript->registerScript('refreshGridView', "
	...
	//setInterval(\"$.fn.yiiGridView.update('data-project-grid')\",5000);
");
...
<?php $this->widget('bootstrap.widgets.TbGridView',array(
	...
	'columns'=>array(
		...
		array(
	        ...
	        'name'=> 'tgl_project',
	        'type'=>'raw',
	        'value' => '(date("d-M-Y",strtotime($data->tgl_project)))',
	        'headerHtmlOptions' => array('style' => 'width:100px;text-align:center;'),
	    ),
		
		array(
	        'header' => 'Rilis_project',
	        'name'=> 'rilis_project',
	        'type'=>'raw',
	        'value' => '(date("d-M-Y",strtotime($data->rilis_project)))',
	        'headerHtmlOptions' => array('style' => 'width:100px;text-align:center;'),
	    ),
	    ...
	    */
		array(
            ...
            (
                'view' => array
                (    
                	'url' => '$data->id_project."|".$data->id_project',              
                	'click' => 'function(){
