<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<label class="control-label">NIK Anda <span class="required">*</span></label>
	</div>
	
	<div style="margin-left:19%; margin-top:-2.5%;">
	<?php echo $form->textField($model,'nik',array('class'=>'span5','maxlength'=>50,'placeholder'=>'NIK Pegawai','minLength'=>5));?>
	<!--,'value'=>Yii::app()->user->getId(),'readOnly'=>true)); ?>-->
	</div>

	<?php $date=date("Y-m-d H:i:s"); echo $form->hiddenField($model,'pulang_time',array('class'=>'span4','value'=>$date)); ?>
...
<div style="margin-top: -8%; margin-left: 19.2%;">
