...
<?php 
$this->widget('bootstrap.widgets.TbButton', array(
	'buttonType'=>'link', 'icon'=>'fa fa-pencil','label'=>'Ubah Data', 'type'=> 'primary','url'=>Yii::app()->createUrl('/personal/updateuser',array('id'=>$decrypt))));
?>
</div>
</div>
</div>
...
<?php
		...
		?>
<?php echo CHtml::beginForm(array('datapendidikan/exportuser')); ?>
...
<?php
		...
		?>
<?php echo CHtml::beginForm(array('dataproject/exportuser')); ?>
<table class="table table-striped">
  <thead class="thead-inverse">
    <tr>
      <th>#</th>
...
$connection->active=true; // open connection
	...
	WHERE r.`nip`='$idd' AND r.`status` LIKE '%Pass%'";
...
<?php echo CHtml::beginForm(array('datatalent/exportuser')); ?>
<table class="table table-striped">
  <thead class="thead-inverse">
    <tr>
      <th>#</th>
