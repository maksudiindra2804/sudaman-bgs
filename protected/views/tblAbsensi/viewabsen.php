...
$connection->active=true; // open connection
    ...
    $que="SELECT a.`id_absen` , a.`nip` , a.`absen_datang` , a.`status` , a.`keterangan` , a.`absen_pulang` , a.`total_jam`
          FROM tbl_absensi a
          WHERE a.`nip`='$idRegis'";
  ...
  <thead>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo $row['absen_datang'];?></td>
                <td><?php echo $row['status'];?></td>
                <td><?php echo $row['absen_pulang'];?></td>
