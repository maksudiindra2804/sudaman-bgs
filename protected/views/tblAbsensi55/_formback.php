<?php $form=$this->beginWidget('bootstrap.widgets.TbActiveForm',array(
	...
	<label class="control-label">NIK Anda</label>
	</div>
	
	<div style="margin-left:19%; margin-top:-2.5%;">
	<?php echo $form->textField($model,'nik',array('class'=>'span5','maxlength'=>50,'placeholder'=>'NIK Pegawai','minLength'=>5,'value'=>Yii::app()->user->getId(),'readOnly'=>true)); ?>
	</div>
