...
$this->menu=array(
	array('label'=>'DataPelatihan','url'=>array('index'),'icon'=>'fa fa-list-alt', 'items' => $menu)	
);
...
Yii::app()->clientScript->registerScript('search', "
	...
	$('.search-form form').submit(function(){
		$.fn.yiiGridView.update('data-pelatihan-grid', {
			data: $(this).serialize()
		});
		return false;
	});
...
Yii::app()->clientScript->registerScript('refreshGridView', "
	...
	//setInterval(\"$.fn.yiiGridView.update('data-pelatihan-grid')\",5000);
");
	    ...
	    */
		array(
            ...
            (
                'view' => array
                (    
                	'url' => '$data->id_pelatihan."|".$data->id_pelatihan',              
                	'click' => 'function(){
