...
$this->menu=array(
	array('label'=>'TblJabatan','url'=>array('index'),'icon'=>'fa fa-list-alt', 'items' => $menu)	
);
...
Yii::app()->clientScript->registerScript('search', "
	...
	$('.search-form form').submit(function(){
		$.fn.yiiGridView.update('tbl-jabatan-grid', {
			data: $(this).serialize()
		});
		return false;
	});
...
Yii::app()->clientScript->registerScript('refreshGridView', "
	...
	//setInterval(\"$.fn.yiiGridView.update('tbl-jabatan-grid')\",5000);
");
	    ...
	    */
		array(
            ...
            (
                'view' => array
                (    
                	'url' => '$data->id_jabatan."|".$data->id_jabatan',              
                	'click' => 'function(){
