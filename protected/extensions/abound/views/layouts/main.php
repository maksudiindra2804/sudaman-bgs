...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="<?php echo $baseUrl;?>/img/icons/banner-crt2.png">
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="<?php echo $baseUrl;?>/img/icons/banner-crt2.png">
    <link rel="apple-touch-icon-precomposed" sizes="72x72" href="<?php echo $baseUrl;?>/img/icons/banner-crt2.png">
    <link rel="apple-touch-icon-precomposed" href="<?php echo $baseUrl;?>/img/icons/banner-crt2.png">
	<?php  
