 ...
 */
class TblPt extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('kode_pt', 'length', 'max'=>20),
			array('nama_pt', 'length', 'max'=>100),
			/*
			//Example username
			...
			array('id_pt, kode_pt, nama_pt', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'personals' => array(self::HAS_MANY, 'Personal', 'id_pt'),
		);
	}
	...
	public function search()
	{
		...
		$criteria->compare('nama_pt',$this->nama_pt,true);
	 ...
	 * @return TblPt the static model class
	 */
